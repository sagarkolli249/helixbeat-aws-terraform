...
variable "ami_id" { description = "Amazon Linux 2 or custom hardened AMI ID"; type = string }
...
variable "target_group_arns" { description = "ALB target group ARNs"; type = list(string); default = [] }
